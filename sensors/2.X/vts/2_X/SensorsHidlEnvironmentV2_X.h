...
class SensorsHidlEnvironmentV2_X : public SensorsVtsEnvironmentBase<::android::hardware::sensors::V2_1::Event> {
public:
...
protected:
   ...
   */
  std::array<::android::hardware::sensors::V2_1::Event, MAX_RECEIVE_BUFFER_EVENT_COUNT> mEventBuffer;
};
