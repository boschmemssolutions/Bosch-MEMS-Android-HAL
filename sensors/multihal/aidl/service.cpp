...
#define LOG_TAG "android.hardware.sensors@aidl-service.multihal.bosch"
...
int main() {
  ...
  binder_status_t status = AServiceManager_addService(halProxy->asBinder().get(), halProxyName.c_str());
